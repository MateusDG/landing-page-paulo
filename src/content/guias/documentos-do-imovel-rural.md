---
titulo: 'Documentos do imóvel rural'
tituloSeo: 'Documentos para comprar imóvel rural: matrícula, CAR, CCIR, ITR e georreferenciamento'
descricao: 'O que cada documento do imóvel rural prova, o que ele não prova, e qual problema aparece quando ele está faltando ou desatualizado.'
resumo: 'Cinco documentos, o que cada um prova e o que acontece quando falta.'
ordem: 2
...
guia explica o que cada peça prova e qual buraco ela tapa.

## Matrícula

É a certidão do registro de imóveis. Descreve o imóvel, seus limites e toda a
história de titularidade, além de ônus, penhoras, hipotecas e usufrutos.

**Prova:** de quem o imóvel é, qual a área registrada e o que pesa sobre ele.
**Não prova:** que a cerca está no lugar certo, nem que a área física
corresponde à registrada.
**Quando falta ou está velha:** você não sabe se está negociando com o dono.

Peça sempre certidão emitida há menos de 30 dias, e leia pelo menos três
titulares para trás.

## Cadastro Ambiental Rural (CAR)

Registro eletrônico obrigatório, feito no SICAR, em que se declaram reserva
legal, áreas de preservação permanente e uso consolidado.

**Prova:** que o imóvel está inscrito e o que o proprietário declarou.
...
Emitido pelo INCRA, comprova a inscrição do imóvel no cadastro rural.
...
Imposto federal anual, declarado pelo próprio proprietário.
...
Levantamento técnico que define o perímetro com coordenadas certificadas pelo
INCRA, no sistema SIGEF.
...
foram escalonados ao longo dos anos e mudam.

## A ordem em que eu peço

Matrícula → CCIR → ITR → CAR → georreferenciamento → outorga de água. Se a
matrícula não passa, o resto não importa.
