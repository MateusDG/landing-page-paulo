...
export const deslocamento: LinhaDeslocamento[] = [
  ...
  { municipio: 'Marechal Floriano', territorio: 'Montanhas', tempo: '1h15', km: 57, asfalto: 100, nota: '—' },
  { municipio: 'Santa Teresa', territorio: 'Montanhas', tempo: '1h20', km: 78, asfalto: 98, nota: 'Neblina densa de junho a agosto' },
  { municipio: 'Anchieta', territorio: 'Litoral', tempo: '1h25', km: 78, asfalto: 100, nota: '—' },
  ...
  { municipio: 'Iconha', territorio: 'Litoral', tempo: '1h45', km: 96, asfalto: 100, nota: '—' },
  { municipio: 'Conceição do Castelo', territorio: 'Montanhas', tempo: '1h50', km: 118, asfalto: 100, nota: '—' },
  ...
  { municipio: 'Castelo', territorio: 'Montanhas', tempo: '2h15', km: 143, asfalto: 100, nota: '—' },
  ...
  { municipio: 'Jaguaré', territorio: 'Norte', tempo: '2h50', km: 189, asfalto: 100, nota: '—' },
  { municipio: 'São Mateus', territorio: 'Norte', tempo: '3h00', km: 213, asfalto: 100, nota: '—' },
  { municipio: 'Alegre', territorio: 'Sul e Caparaó', tempo: '3h10', km: 196, asfalto: 100, nota: 'Serra a partir de Cachoeiro' },
  { municipio: 'Nova Venécia', territorio: 'Norte', tempo: '3h20', km: 225, asfalto: 100, nota: '—' },
